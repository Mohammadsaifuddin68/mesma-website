...
export const metadata: Metadata = {
  title: "AI Receptionist for Businesses | Mesma",
  description: "Never miss a customer call again with Mesma AI Receptionist. Answer calls, route inquiries, and qualify leads automatically.",
};
